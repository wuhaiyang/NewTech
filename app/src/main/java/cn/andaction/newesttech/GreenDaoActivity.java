...
import cn.andaction.greendao.DaoMaster;
import cn.andaction.greendao.DaoSession;
import cn.andaction.greendao.Note;
import cn.andaction.greendao.NoteDao;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < 100000; i++) {
                    getNoteDao().insert(new Note(null, "gxt" + i, "fuckIngAlert" + i, new Date()));
                }
                long time2 = System.currentTimeMillis();
                long diff = time2 - time1;

                Log.w("TIME", String.valueOf(diff / 1000));
            }
        }).start();
